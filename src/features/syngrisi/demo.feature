...
Feature: Syngrisi demo
    ...
    Scenario: Graph Visual Checking - Broken Data
        # 1
        When I open the url "http://localhost:8888/?version=0"
        When I visually check "#graph" element as "Graph"

    Scenario: Full Page Visual Checking - Text extra dot
        # 4
        When I open the url "http://localhost:8888/lorem?version=1"
...
#    Scenario: Full Page Visual Checking - Extra Dot in the Footer
#        When I open the url "<string>"

#     Scenario: ViewPort Functional Theme Visual Checking
#        When I open the url "<string>"
#
#    Scenario: ViewPort Functional Theme Visual Checking - Broken Theme Button
#        When I open the url "<string>"
#
